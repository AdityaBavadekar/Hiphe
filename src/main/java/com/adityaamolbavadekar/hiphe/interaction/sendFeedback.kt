...
object sendFeedback {
    ...
    private fun sendFeedback(context: Context, thread: Thread, throwable: Throwable) {
...
//        exitProcess(0)
    ...
    private fun createAchooser(context: Context, value: String) {
